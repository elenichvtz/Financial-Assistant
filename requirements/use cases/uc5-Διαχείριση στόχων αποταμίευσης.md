...
![Διάγραμμα Δραστηριότητας ΠΧ6](diagrams/uc5-εισαγωγή.png)

<h3>Διάγραμμα Δραστηριότητας - Τροποποίησης στόχου</h3>

![Διάγραμμα Δραστηριότητας ΠΧ6](diagrams/uc5-τροποποίηση.png)

<h3>Διάγραμμα Δραστηριότητας - Διαγραφής στόχου</h3>

![Διάγραμμα Δραστηριότητας ΠΧ6](diagrams/uc5-διαγραφή.png)
