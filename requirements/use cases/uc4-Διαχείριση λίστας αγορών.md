...
7. Ο Χρήστης επαναλαμβάνει τα βήματα 4, 5 και 6 μέχρι να βάλει όλα τα προϊόντα που θέλει στη λίστα.
8. Το σύστημα αποθηκεύει τη νέα λίστα αγορών.
9. Το σύστημα δημιουργεί εγγραφή της λίστας στα έξοδα.
