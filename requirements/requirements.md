...
| **ΠΧ4** | ιαχείριση λίστας αγορών |Ο χρήστης δημιουργεί λίστες αγαθών προς αγορά, οι οποίες δημιουργούν κατάλληλη εγγραφή στα έξοδα.|
...
<!--Μπορείτε να συνοψίσετε τις κυριότερες ανάγκες τους από τις ΠΧ.-->
