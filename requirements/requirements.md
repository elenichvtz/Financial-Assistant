...
<h2>Απαιτήσεις διεπαφών</h2>



<h2>Περιορισμοί σχεδίασης και υλοποίησης</h2>

<h3>Διεπαφές χρήστη</h3>

<h3>Διεπαφές υλικού</h3>

<h3>Διεπαφές επικοινωνίας</h3>

<h3>Διεπαφές λογισμικού</h3>
